...
static void GPIO_Config(void)
{
  ...
  //GPIO_Init(JOYSTICK_PORT, (GPIO_Pin_TypeDef)(JOYSTICK_LEFT_PIN|JOYSTICK_RIGHT_PIN|JOYSTICK_UP_PIN|JOYSTICK_DOWN_PIN), GPIO_MODE_IN_FL_IT);
  
  GPIO_Init(SYNC_PORT, SYNC_VS_PIN, GPIO_MODE_IN_PU_IT);
  GPIO_Init(SYNC_PORT, SYNC_HS_PIN, GPIO_MODE_IN_PU_IT);
}
